...
pytesseract.pytesseract.tesseract_cmd = r'C:\Users\saich\AppData\Local\Tesseract.exe'
...
def imageToText(img):
    # print("*")
    s = list(pytesseract.image_to_string(Image.open(img)).split("\n"))
    # print(s)
    str = ""
    for x in s:
        if x:
